...
def main():
    ...
    if "messages" not in st.session_state:
        st.session_state["messages"] = [{
            "role" : "system",
            "content" : "You are a sweet babe. Respond to all input in 25 words and ansewer in Koran"
        }]
    ...
    with st.sidebar:
        ...
        if st.button(label="초기화"):
            ...
            st.session_state["messages"]=[{
                "role" : "system",
                "content":"You are a sweet babe. Respond to all input in 25 words and answer in korean"
            }]
            ...
            for sender, time, message in st.session_state["chat"]:
                if sender == "user":
                    ...
                    st.write(f"""<div style="display:flex;align-items:center;justify-content:flex-end;">
                             ...
                             {message}</div><div style="font-size:0.8rem; color:black;">{time}</div></div>""",unsafe_allow_html=True)
                    st.write("")
